...
public class Latihan7 {
    ...
    public static void main(String[] args) {
        ...
        switch(pilih){
            case 'a' -> System.out.println("Benar !");
            case 'b' -> System.out.println("Salah,jawabannya adalah Dr.Ir.H.Soekarno");
            case 'c' -> System.out.println("Salah,jawabannya adalah Dr.Ir.H.Soekarno");
            case 'd' -> System.out.println("Salah,jawabannya adalah Dr.Ir.H.Soekarno");
